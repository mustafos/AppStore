...
//        UIView.appearance().semanticContentAttribute = .forceLeftToRight
    ...
    private func setConfigLabels_TOC(){
        ...
        titleLb.font = UIFont(name: Configurations_REFACTOR.getSubFontName(), size: 24)
...
extension ReusableView : UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if selectedStorage.contains(where: {$0 == indexPath.item}) {
            ...
            cell.cellLabel.font = UIFont(name: Configurations_REFACTOR.getSubFontName(), size: 12)
            ...
            cell.cellLabel.font = UIFont(name: Configurations_REFACTOR.getSubFontName(), size: 10)
