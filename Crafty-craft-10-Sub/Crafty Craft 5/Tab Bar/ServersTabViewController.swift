...
class ServersTabViewController: UIViewController {
    ...
    private func showEmptyMessage() {
        if emptyMessageLabel == nil {
            ...
            emptyMessageLabel?.text = "Nothing found in servers"
...
extension ServersTabViewController: TabBarVersatile {
