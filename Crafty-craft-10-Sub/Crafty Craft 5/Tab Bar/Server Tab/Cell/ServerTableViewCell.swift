...
class ServerTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        serverIcon.heightAnchor.constraint(equalToConstant: Device.iPad ? 360 : 184).isActive = true
        subContainer.roundCorners(30)
        ...
        namingInfoView.roundCorners(20)
    ...
    private func addLoader() {
        ...
        NSLayoutConstraint.activate([
            ...
            loader.centerYAnchor.constraint(equalTo: contentView.centerYAnchor, constant: -20),
        ])
        loader.startAnimating()
    }
