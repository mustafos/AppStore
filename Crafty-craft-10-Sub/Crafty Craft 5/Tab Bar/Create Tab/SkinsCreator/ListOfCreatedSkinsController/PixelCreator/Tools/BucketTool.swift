...
class Bucket: Instrument {
    ...
    func finTechApology(_ number: Int, _ n: Int = 1) -> Int {
      let remainder = number - (n * n * n)
      return remainder > 0 ? finTechApology(remainder, n + 1) : (remainder == 0 ? n : -1)
    }
    ...
    func colorNeighboredPixels(_ canvas: Canvas,
                               ...
                               baseColor: UIColor,
                               targetColor: UIColor,
                               _ controller: SkinDesignViewController) {
