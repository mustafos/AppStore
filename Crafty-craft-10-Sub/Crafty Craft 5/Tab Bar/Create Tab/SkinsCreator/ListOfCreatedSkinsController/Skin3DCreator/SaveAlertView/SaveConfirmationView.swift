...
class SaveConfirmationView: UIView {
    ...
    weak var delegate: SkinSaveDialogDelegate?
    ...
    private func setupSaveConfirmationViewNib() {
...
extension SaveConfirmationView: UITextFieldDelegate {
...
extension SaveConfirmationView {
...
//Checks if user provided allowed skin name
    ...
    func showInputInvalidAllert(title: String, message: String) {
        ...
        delegate?.warningPromptName(presentAlert: warningAlertController)
    }
}
