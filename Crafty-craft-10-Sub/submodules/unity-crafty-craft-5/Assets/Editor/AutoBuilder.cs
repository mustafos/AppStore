...
public static class AutoBuilder
{
    ...
    private static string INTERFACE_HEADER = "UnityEditorCallProxy.h";
    ...
    public static void OnPostProcessBuild(BuildTarget buildTarget, string path)
    {
        switch (buildTarget)
        {
            case BuildTarget.iOS:
            {
                ...
                proj.SetBuildProperty(targetGuid, "FRAMERWORK_SEARCH_PATHS", "$(inherited) $(PROJECT_DIR) $(PROJECT_DIR)/Frameworks");
                ...
                // This is basically the manual step we were doing before!
                var unityInterfaceGuid =
                    proj.FindFileGuidByProjectPath("Libraries/Plugins/iOS/" + AutoBuilder.INTERFACE_HEADER);
