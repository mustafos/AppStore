...
class EditorSkinModel {
    private(set) weak var controller: Skin3DTestViewController!
    ...
    private(set) var assemblyDiagramSize: SkinAssemblyDiagramSize = .size64x64
    private(set) var skinCreatedModel: SkinCreatedModel?
    ...
    //MARK: init
    init(viewController: Skin3DTestViewController, skinCreatedModel: SkinCreatedModel, assemblyDiagramSize: SkinAssemblyDiagramSize) {
