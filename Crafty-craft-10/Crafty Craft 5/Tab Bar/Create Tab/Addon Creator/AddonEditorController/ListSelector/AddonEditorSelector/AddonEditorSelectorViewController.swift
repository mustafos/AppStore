...
class AddonEditorSelectorViewController: UIViewController {
    ...
    private let addonModel: SavedAddon
    ...
    private let mcAddonFileManager: MCAddonFileManagerProtocol
    
    private weak var delegate: AddonEditorSelectorDelegate?
    
    init(addonModel: SavedAddon, resourcePack: [ResourcePack], mcAddonFileManager: MCAddonFileManagerProtocol, delegate: AddonEditorSelectorDelegate) {
