...
class AddonEditorViewController: UIViewController {
    ...
    private var model: AddonEditorModel
    private var mode: AddonEditorMode
...
//
    ...
    init(addonModel: SavedAddon, mode: AddonEditorMode = .create) {
        self.model = AddonEditorModel(addonModel: addonModel)
        self.mode = mode
...
extension AddonEditorViewController: ModPropertiesChangeable {
    ...
    func textFieldChanged(value: String, cellName: String, sender: UITextField) {
        ...
        switch cellName {
        case AddonEditorModel.Field.amount:
        ...
        case AddonEditorModel.Field.health:
        ...
        case AddonEditorModel.Field.attackSpeed:
        ...
        case AddonEditorModel.Field.moveSpeed:
        ...
        case AddonEditorModel.Field.attackRadius:
